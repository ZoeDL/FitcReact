 ...
 * 日期时间工具类
 * @Author: Yuhao Zhang 
 * @Date: 2018-04-09 09:49:41 
 * @Last Modified by: Honye
 * @Last Modified time: 2018-04-09 09:56:29
 */
'use strict';
...
/**
 * 格式化时间,不传 fmt，则默认为 yyyy-MM-dd hh:mm:ss ;
 * @param date
 * @param fmt
 * @returns {*}
 */
...
/**
 * 将字符串时间转Date,是将 字符串类型的时间 转化成 Date 类型的工具方法
 * @param {*} dateStr 
 */
...
/**
 * 得到一天的开始,Date,今天是4.18, 那返回的是今天 00:00:00的Date类型
 * @param {*} date 
 */
...
/**
 * 得到一天的开始,字符串,今天是4.18, 那返回的是今天 00:00:00的字符串类型
 * @param {*} date 
 * @param {*} fmt 
 */
...
/**
 * 得到一天的结束， Date 今天是4.18, 那返回的是今天 23:59:59的Date类型
 * @param {*} date 
 */
...
/**
 * 得到一天的结束 字符串，今天是4.18, 那返回的是今天 23:59:59的字符串类型
 * @param {*} date 
 * @param {*} fmt 
 */
...
/**
 *  比较日期，比较两个日期的大小 返回 1 , 则 d1 > d2 返回 0 , 则 d1 == d2 返回 -1, 则 d1 < d2
 * @param {*} d1 
 * @param {*} d2 
 */
...
/**
 * 增加天数 Date，DateFormat.addDay(new Date(), 3);   //返回是三天后的  Date类型
 * @param {*} date 
 * @param {*} dayNum 
 */
...
/**
 * 增加天数 字符串 DateFormat.addDayStr('2017-04-18 12:12:12', 3) // 返回 Fri Apr 21 2017 12:12:12 GMT+0800 (中国标准时间)
 * @param {*} dateStr 
 * @param {*} dayNum 
 */
...
/**
 * 得到今天是星期几，type非必传，默认返回 '星期 X'的格式
 * @param {*} date 
 * @param {*} type 
 */
...
/**
 * 毫秒转字符, < 1 小时的单位为分钟, >= 1 小时的单位为小时
 * @param {Number} ms 毫秒
 * @return {String} 
 */
dateformat.ms2str = function(ms) {
    if( ms < 3600000 ) {
